    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <x-input-field type="text" name="nama" id="nama" placeholder="Nama Pelajaran" label="Nama" isAjax="true"/>
            </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            var table = $('#datatable').DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.pelajaran.index') }}",
                    data: function (data) {}
                },
                columns: [{
                        data: 'nama',
            ...
            $('#myForm').submit(function (e) {
                ...
                if(id != ''){
                    url = "/admin/master/pelajaran/"+id + "/update";
                }else{
                    url = "/admin/master/pelajaran/store";
                }
                ...
                $.ajax({
                    ...
                    type: "POST",
                    url:  url,// Pastikan URL sesuai dengan route untuk menyimpan data pelajaran
                    data: formData,
        ...
        function ubah(id)
        {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#myForm').find('h5.modal-title').text('Ubah Pelajaran');
        ...
        .then((result) => {
            if (result.value) {
            $.ajax({
                url: "/admin/master/pelajaran/" + id +"/delete",
                type: 'DELETE',
                dataType: 'json',
                data: {
