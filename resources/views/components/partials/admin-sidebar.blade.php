                ...
                <li class="sidebar-item has-sub {{ (request()->is('admin/master/*')) ? "active" : "" }}"">
                    ...
                    <ul class="submenu submenu-closed">
                        <li class="submenu-item">
                            <a href="{{ route('admin.kelas.index') }}" class="submenu-link">Kelas</a>
                        </li>
                        <li class="submenu-item">
                            <a href="{{ route('admin.pelajaran.index') }}" class="submenu-link">Pelajaran</a>
                        </li>
                        <li class="submenu-item">
                            <a href="{{ route('admin.tahun.index') }}" class="submenu-link">Tahun Ajaran</a>
                        </li>
                    </ul>
