...
class SiswaController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            ->addColumn('action', function($row){
                $btn = '<a class="btn btn-primary btn-sm" href='. route('guru.siswa.show', ['id' => $row->id]) .'><i class="fa fa-list"></i> Detail</a>';
                return $btn; 
            })
            ->rawColumns(['action']) 
            ->make(true);
    ...
    {
        return view('dashboard.guru.siswas.create');
    }
    ...
    public function show(string $id)
    {
        ...
        return view('guru.siswa.show', compact('data'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('dashboard.guru.siswas.edit', compact('siswa'));
    }
    ...
    public function data(Request $request)
    {
        ...
        $data = Siswa::whereHas('kelas', function($q) use($request) {
            return $q->where('tahun_id', $request->tahun_id)
